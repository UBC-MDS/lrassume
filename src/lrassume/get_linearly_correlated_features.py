def get_linearly_correlated_features(df: pandas.DataFrame, target: str, threshold: float = 0.7) -> pandas.DataFrame: 
  ...
  >>> get_linearly_correlated_features(df=df_example, target="price", threshold=0.7)
          feature  correlation
  0          sqft     0.994
  1            age    -0.952
  2      num_rooms     0.703
