# check_homoscedasticity { #lrassume.check_homoscedasticity }
...
| Name | Description |
| --- | --- |
| [check_homoscedasticity](#lrassume.check_homoscedasticity.check_homoscedasticity) | Test for homoscedasticity (constant variance) in linear regression residuals. |

### check_homoscedasticity { #lrassume.check_homoscedasticity.check_homoscedasticity }
...
|-----------------|--------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|
| `X`             | pd.DataFrame | DataFrame of predictors (features). Each column is a predictor variable. Must contain only numeric columns.                                                                                                                                                     | _required_        |
| `y`             | pd.Series    | Target variable (response). Must have the same length as X.                                                                                                                                                                                                     | _required_        |
